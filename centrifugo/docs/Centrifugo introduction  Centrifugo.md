---
created: 2026-03-06T18:10:26 (UTC +07:00)
...
source: https://centrifugal.dev/docs/getting-started/introduction
author: 
---

# Centrifugo introduction | Centrifugo

> ## Excerpt
> Centrifugo is an open-source real-time messaging server for chats, live updates, multiplayer games, streaming AI responses, and more. WebSocket, SSE, HTTP-streaming.

---
![](https://centrifugal.dev/img/logo_animated_no_accel.svg)
...
![](https://centrifugal.dev/assets/images/bg_cat-975c20ed8cf4a65568bc628c638050f9.jpg)

Prefer podcast format? (22 MB)
...
## Background and motivation[](https://centrifugal.dev/docs/getting-started/introduction#background-and-motivation "Direct link to Background and motivation")
...
<iframe src="https://www.youtube.com/embed/bXLulUWoOqE?si=ZTBhxF7uDCCqRWI_" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen=""></iframe>
