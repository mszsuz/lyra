...
| `config_id` | `2xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx` | Идентификатор типовой конфигурации (MD5 от платформенного ПолучитьИдентификаторКонфигурации() без последней строки). Вычисляется в обработке, без зависимостей |
