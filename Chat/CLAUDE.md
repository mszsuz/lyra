...
6. Чат отображает QR-код = `mobile_jwt` (срок жизни 1 год)
...
| `config_id` | `2xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx` | Идентификатор конфигурации. MD5 от платформенного ПолучитьИдентификаторКонфигурации() без последней строки. У недоработанных типовых одной версии совпадает, у доработанных/снятых с поддержки — свой. Вычисляется в обработке, без зависимостей |
