...
MCP-инструменты: `lyra_data_query` (запрос), `lyra_meta_list` (метаданные), `lyra_data_eval` (вычисление), `lyra_data_exec` (выполнение кода), `lyra_nav_resolve` (навигационные ссылки).
